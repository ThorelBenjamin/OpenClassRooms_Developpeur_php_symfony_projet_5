...
<div>
    ...
    <table class="monitoringAdmin">
        <tr>
            ...
            <th><a href="?action=monitoringAdmin&prepare=nombre_commentaire&order=<?= htmlspecialchars($order) === 'asc' ? 'desc' : 'asc' ?>">Nbr commentaire <i class="fa-solid fa-arrow-down-up-across-line"></i></th>
